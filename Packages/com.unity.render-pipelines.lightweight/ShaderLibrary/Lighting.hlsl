...
///////////////////////////////
//  [ADDED] Volume Lighting  //
///////////////////////////////
#define _VOLUME_LIGHTS
...
uniform float4 _VolumeLightOriginBuffer[64];

float BoxSDF(float4x4 transform, float3 extents, float3 pos) {
...
half3 ComputeVolumeLights(BRDFData brdfData, float3 worldPos, half3 normalWS, half3 viewDirectionWS) {
	float dist = float(0);
    ...
    half smoothness, half occlusion, half3 emission, half alpha)
{
	...
	// Compute Volume Lighting
	color += ComputeVolumeLights(brdfData, inputData.positionWS, inputData.normalWS, inputData.viewDirectionWS);
